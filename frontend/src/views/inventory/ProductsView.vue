...
<template>
  <main class="max-w-7xl mx-auto">
    ...
    <Dialog v-model:visible="showAddEditModal" :modal="true" class="w-full max-w-3xl">
      <template #header>
    ...
    <!-- Analytics Modal -->
    <Dialog v-model:visible="showAnalyticsModal" :modal="true" class="w-full max-w-6xl">
      <template #header>
    ...
    <!-- Export Modal -->
    <Dialog v-model:visible="showExportModal" :modal="true" class="w-full max-w-lg">
      <template #header>
        <div class="flex flex-col">
          <div class="flex items-center gap-3">
      ...
      <div class="space-y-6 p-4">
        ...
        <div class="space-y-2">
          ...
          <Select
            :options="[
              {
                label: `Produtos selecionados (${selectedProducts.length})`,
                value: 'selected',
        ...
        <div class="bg-green-50 p-4 rounded-lg">
          ...
          <div class="text-sm text-green-800 space-y-1">
            ...
            <p>
              •
              {{
                categories.filter((cat) => productStore.products.some((p) => p.category === cat))
                  .length
              }}
