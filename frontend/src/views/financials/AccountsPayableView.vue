<template>
  <div class="p-4 sm:p-6 max-w-7xl mx-auto">
    ...
    <div class="bg-surface-50 p-6 rounded-lg shadow-md mb-6">
      ...
      <form
        @submit.prevent="isEditing ? handleUpdateAccountPayable() : handleAddAccountPayable()"
        class="space-y-4"
      >
        ...
        <div class="flex flex-col" v-if="newAccount.is_paid">
          <label for="paidDate" class="block text-sm font-medium text-surface-700"
    ...
    <div class="bg-surface-50 p-6 rounded-lg shadow-md mb-6">
      ...
      <div
        ...
        v-else-if="financialTransactionsStore.getUnpaidAccounts.length > 0"
      >
          ...
          <tbody class="bg-white divide-y divide-surface-200">
            <tr v-for="account in financialTransactionsStore.getUnpaidAccounts" :key="account.id">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                ...
                <button
                  @click="handleDeleteAccountPayable(account.id)"
