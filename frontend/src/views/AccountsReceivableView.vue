<template>
  <div class="accounts-receivable-container">
    ...
    <div class="form-section">
      ...
      <form @submit.prevent="isEditing ? handleUpdateAccountReceivable() : handleAddAccountReceivable()">
        ...
        <div class="form-group" v-if="newAccount.is_received">
          ...
          <input type="date" id="receivedDate" v-model="newAccount.received_date" :required="newAccount.is_received" />
        </div>
        ...
        <tbody>
          <tr v-for="account in accountsReceivableStore.getUnreceivedAccounts" :key="account.id">
            ...
            <td>
              ...
              <button @click="markAsReceived(account.id)" v-if="!account.is_received">Marcar como Recebida</button>
              <button @click="handleDeleteAccountReceivable(account.id)" class="delete-button">Excluir</button>
            </td>
          </tr>
        </tbody>
      </table>
