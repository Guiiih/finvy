  ...
  <div>
    ...
    <div class="p-6 rounded-lg bg-surface-50">
      ...
      <div
        ...
        class="bg-yellow-50 text-yellow-700 p-4 mb-4 rounded-lg"
      >
            ...
            <form @submit.prevent="handleSubmitMember" class="space-y-4">
              <div>
                ...
                <div
                  ...
                  class="mt-2 border rounded-md shadow-lg max-h-48 overflow-y-auto"
                >
                  <ul>
                    <li
          ...
          <div class="bg-surface-50 rounded-lg">
            ...
            <ul v-else-if="filteredMembers.length > 0" class="space-y-3">
              <li
                ...
                :key="member.id"
                class="flex items-center justify-between p-4 rounded-lg bg-surface-50 hover:bg-surface-100"
              >
                <div class="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <span
                      class="text-xs font-semibold bg-emerald-200 text-emerald-800 px-2 py-0.5 rounded-full"
                      >{{ member.role }}</span
                    >
                  </div>
                </div>
  ...
  if (selectedOrganizationId.value) {
    try {
      ...
      toast.add({
        severity: 'success',
        summary: 'Sucesso',
        detail: 'Organização ativa alterada!',
        life: 3000,
      })
    } catch (err: unknown) {
      console.error(err)
...
async function handleUpdateOrganizationDetails() {
  ...
  try {
    ...
    toast.add({
      severity: 'success',
      summary: 'Sucesso',
      detail: 'Detalhes da organização atualizados!',
      life: 3000,
    })
  } catch (err: unknown) {
    console.error(err)
