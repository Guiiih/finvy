  ...
  <div class="p-4 sm:p-6 max-w-7xl mx-auto">
    ...
    <div v-else class="bg-surface-50 p-6 rounded-lg shadow-md">
      <div v-for="type in accountStore.accountTypes" :key="type" class="mb-6 last:mb-0">
        <h2 class="text-xl font-semibold text-emerald-600 border-b-2 border-emerald-600 pb-2 mb-4">
        ...
        <ul>
          <li
            ...
            :key="account.id"
            class="flex items-center py-2 border-b border-surface-200 last:border-b-0"
          >
