      ...
      children: [
        {
          path: 'dre',
          name: 'dre-report',
          component: () => import('../views/reports/DREReport.vue'),
        ...
        },
        {
          path: 'dfc',
          name: 'dfc-report',
          component: () => import('../views/reports/DFCReport.vue'),
          meta: { requiresAuth: true, title: 'DFC' },
        },
        {
          path: 'variations',
          name: 'variations',
          component: () => import('../views/reports/VariationView.vue'),
          meta: { requiresAuth: true, title: 'Variações' },
        },
        {
          path: 'trial-balance',
          name: 'trial-balance',
          component: () => import('../views/reports/TrialBalanceView.vue'),
