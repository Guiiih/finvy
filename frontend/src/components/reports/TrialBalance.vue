...
const totalDebits = computed(() =>
  trialBalanceData.accounts.reduce((sum, acc) => sum + (acc.debit || 0), 0),
)
const totalCredits = computed(() =>
  trialBalanceData.accounts.reduce((sum, acc) => sum + (acc.credit || 0), 0),
)
const totalBalance = computed(() =>
  trialBalanceData.accounts.reduce((sum, acc) => sum + acc.balance, 0),
)
