  ...
  <div class="p-4 sm:p-6">
    <div class="flex justify-between items-center mb-4">
        ...
        <div class="flex items-center gap-2">
            <Dropdown v-model="selectedPeriod" :options="periodOptions" optionLabel="label" optionValue="value" placeholder="Selecione o Período" />
    ...
    <div v-else>
        <Card>
            <template #content>
                <p>Relatório selecionado '{{ reportId }}' não possui um componente de visualização definido.</p>
            </template>
        </Card>
    </div>
  </div>
