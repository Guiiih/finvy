  ...
  describe('calculateTrialBalance', () => {
    it('deve calcular o balancete de verificação corretamente', () => {
      ...
      const accounts: Account[] = [
        ...
        { id: '2', name: 'Fornecedores', type: 'Passivo Circulante', code: 201 },
      ...
      const fornecedoresAccount = result.find(a => a.accountName === 'Fornecedores');
      const receitaAccount = result.find(a => a.accountName === 'Receita de Vendas');
      const despesaAccount = result.find(a => a.accountName === 'Despesas com Salários');
